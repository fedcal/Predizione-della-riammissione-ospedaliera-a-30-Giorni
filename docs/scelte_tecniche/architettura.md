...
nav_order: 1
description: >-
  Architettura modulare della pipeline Hospital Readmission 30d: layout
  della repo, moduli src/readmit_pipeline/, flusso dati end-to-end e CLI
  (readmit-train, readmit-predict).
---
