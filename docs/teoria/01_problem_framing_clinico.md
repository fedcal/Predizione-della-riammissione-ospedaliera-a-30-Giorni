...
math: mathjax
description: >-
  Definire il problema della readmission a 30 giorni: HRRP, binarizzazione
  della target multiclasse, matrice dei costi asimmetrica e implicazioni
  sulle scelte modellistiche.
---
