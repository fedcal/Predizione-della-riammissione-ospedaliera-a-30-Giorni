...
math: mathjax
description: >-
  Strategie di preprocessing per dati clinici reali: missing non standard
  (?), ICD-9 macro-grouping, IDS mapping, encoding farmaci diabetici e
  scaling per modelli sensibili alla scala.
---
