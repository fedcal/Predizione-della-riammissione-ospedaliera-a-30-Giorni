...
math: mathjax
description: >-
  Audit di equità in modelli predittivi clinici: Fairlearn MetricFrame,
  demographic parity, equalized odds, predictive parity. Trade-off fra
  definizioni di fairness incompatibili e implicazioni cliniche.
---
