...
math: mathjax
description: >-
  Interpretabilità di modelli clinici: coefficienti LR, feature importance
  Random Forest, analisi degli errori (falsi negativi), automation bias e
  limiti strutturali del dataset UCI 296.
---
