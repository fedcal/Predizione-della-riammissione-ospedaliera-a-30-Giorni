...
math: mathjax
description: >-
  Analisi esplorativa del dataset Diabetes 130-US Hospitals: distribuzione
  della target binarizzata, demografia, missing non standard, encounter
  multipli e pattern clinici rilevanti.
---
